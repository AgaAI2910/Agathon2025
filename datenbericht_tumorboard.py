...
with st.expander("### Informationen zum Datensatz"):
    ...
    with st.expander("Fallnummer"):
        ...
        st.image("plots/Fallnummer_haeufigkeit_mit_nan.png",  width=600)

    with st.expander("Geschlecht"):
        st.markdown("Geschlecht des Patienten.")
        st.image("plots/G_haeufigkeit_mit_nan.png",  width=600)
    ...
    with st.expander("Vorst AdHoct"):
        ...
        st.image("plots/Vorst AdHoc_haeufigkeit_mit_nan.png",  width=600)
    ...
    with st.expander("Vorst Elektiv"):
        ...
        st.image("plots/Vorst Elektiv_haeufigkeit_mit_nan.png",  width=600)
